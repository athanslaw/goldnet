<section class="content-header">
      <h1>Manage CMS<div class="<?=$class?>"><?=$content?></div></h1>
      <ol class="breadcrumb">
    ...
    <!-- Profile Image -->
        ...
        <div class="col-sm-5 bg-gray">
			<form action="" method="post" name="frm" enctype="multipart/form-data">
				<br><img src="<?=base_url().'images/'.getCMS('icon')?>" alt="" width="153" id="blah1"><br><h3>Upload Favicon</h3>
				<input type="file" name="file" id="file" onchange="readURL1(this, 'blah1');" /><br>
				<!-- /.box-body -->
            	<input type="submit" name="iconbtn" id="button" class="btn bg-primary" value="Submit" /><br><br>
			</form>

        </div>
		<div class="col-sm-5 bg-gray-active">
        	<form action="" method="post" name="frm1" enctype="multipart/form-data">
				<br><img src="<?=base_url().'images/'.getCMS('logo')?>" alt="" width="153" id="blah"><br><h3>Upload Logo</h3><br>
				<input type="file" name="file" id="file"  onchange="readURL1(this,'blah');" /><br>
				<!-- /.box-body -->
            	<input type="submit" name="logobtn" id="button" class="btn bg-primary" value="Submit" /><br><br>
			</form>
