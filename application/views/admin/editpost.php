    ...
    <!-- Profile Image -->
        ...
        <div class="<?=$class?>"><?=$content?></div>
							...
							<span>Cover Page</span>
								...
								<input type="text" name="title" class="form-control" required="required" value="<?=$books->title?>" /><br>
								<input type="text" name="author_name" class="form-control" value="<?=$books->author_name?>" placeholder="Author name" /><br>
								<input type="text" name="author_site" class="form-control" value="<?=$books->author_site?>" placeholder="Author site" /><br>
								<input type="email" name="author_email" class="form-control" value="<?=$books->author_email?>" placeholder="Author email" /><br>
								...
								<input type="text" name="amount" class="form-control" value="<?=$books->amount?>" />
								<!-- /.box-header -->
								<div class="box-body">
