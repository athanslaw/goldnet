<form id="frm_educ_details" method="post" action="<?php echo base_url();?>account/add_certification_entry">
  
		<div class="form-group">
			<label>Certification/Membership Title*</label>
			<input class="form-control required" type="text" name="certificate_member_ship" id="certificate_member_ship" value=""  />
