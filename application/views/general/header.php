                ...
                <nav class="navbar navbar-default outer-width" id="navigation">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav">
                          ...
                          <li class="<?=$activepage=="recommended"?"active":"" ?>"><a href="<?=base_url()?>pages/recommended">Hot Links</a></li>
                          <li class="<?=$activepage=="about-us"?"active":"" ?>"><a href="<?=base_url()?>page/about-us">About Us</a></li>
                          <li class="<?=$activepage=="I-Recharge"?"active":"" ?>"><a href="<?=base_url()?>pages/irecharge">I-Recharge</a></li>
						  <?php foreach($pagess as $page){?>
							<li class="<?=$activepage==$page->slug?"active":"" ?>"><a href="<?php echo base_url()?>page/<?=$page->slug ?>"><?=ucfirst($page->page_title) ?></a></li>
						<?php }?>
                          <li class="add_busi_btn	"><a href="<?=base_url() ?>signup">+ Signup</a></li>
                          <li class="add_busi_btn"><a href="<?=base_url() ?>signin" style="background-color:#063">Sign in</a></li>
                      </ul>      
                    </div><!-- /.navbar-collapse -->
                </nav>
                <!--Navigation Start-->
